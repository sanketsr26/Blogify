...
function HomeGuest() {
    ...
    switch (action.type) {
      ...
      case "usernameUniqueResults":
        if (action.value) {
          ...
          draft.username.message = `${draft.username.value} is already taken.`
        } else {
      ...
      case "emailUniqueResults":
        if (action.value) {
          ...
          draft.email.message = `${draft.email.value} is already being used.`
        } else {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    //before submitting, perform form validation
